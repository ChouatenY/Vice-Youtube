  ...
  return (
    <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <section className="py-16 text-center">
        <h1 className="text-4xl font-extrabold tracking-tight lg:text-5xl mb-6 text-primary">
        ...
        <Link href="/dashboard">
          <Button size="lg" className="mt-4 bg-primary hover:bg-primary/80 text-white">
            Try It Now
          </Button>
        </Link>
      </section>
      ...
      <section className="py-16 border-t">
        ...
        <div className="space-y-8 max-w-3xl mx-auto">
          <div className="rounded-lg border bg-card p-6">
            <h3 className="text-xl font-semibold mb-2 text-primary">How accurate are the transcripts?</h3>
          ...
          <div className="rounded-lg border bg-card p-6">
            <h3 className="text-xl font-semibold mb-2 text-primary">Are there any video length limitations?</h3>
          ...
          <div className="rounded-lg border bg-card p-6">
            <h3 className="text-xl font-semibold mb-2 text-primary">Is this service free to use?</h3>
            <p className="text-card-foreground/70">Yes! Our YouTube Video Analyzer is completely free to use. You can analyze videos, save your analyses, and access all features without any subscription or payment.</p>
          </div>
        </div>
      </section>
      ...
      <footer className="py-12 border-t mt-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          <div>
            <h3 className="font-bold mb-4 text-primary">YouTube Analyzer</h3>
